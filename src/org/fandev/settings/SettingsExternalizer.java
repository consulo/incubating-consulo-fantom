...
public abstract class SettingsExternalizer
{
	...
	protected EnumMap<SettingAttribute, String> buildOptionsByName(final List<Element> children)
	{
		...
		{
			final SettingAttribute settingAttribute = SettingAttribute.byAttributeKey(getAttributeFromElement(NAME, elem));
	 ...
	 */
	public void writeOption(@Nullable final SettingAttribute attribute, @Nullable final String value, @NotNull final Element elem)
	{
