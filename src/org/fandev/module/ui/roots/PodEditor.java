...
public class PodEditor extends ModuleElementsEditor
{
	...
	protected JComponent createComponentImpl()
	{
		...
		final BrowseFilesListener outDirBrowseListener = new BrowseFilesListener(resDirs, FanBundle.message("pod.outDir"),
				FanBundle.message("pod.outDir"), resDirsChooser)
		{
			@Override
			public void actionPerformed(final ActionEvent e)
			{
		...
		if(moduleFile != null)
		{
			...
			dependenciesChooser.setRoot(VirtualFileUtil.refreshAndFindFileByLocalPath(VirtualFileUtil.buildUrl(getState().getRootModel().getSdk().getHomePath
					(), "lib/fan")));
			dependenciesChooser.addRoot(v);
		}
		final BrowseFilesListener dependenciesBrowseListener = new BrowseFilesListener(dependencies, FanBundle.message("pod.dependencies"),
				FanBundle.message("pod.dependencies"), dependenciesChooser)
		{
			@Override
			public void actionPerformed(final ActionEvent e)
			{
		...
		final FanFieldPanel indexesPanel = new FanFieldPanel(indexes, FanBundle.message("pod.indexes"), FanBundle.message("pod.indexes"), indexesListener,
				null);
