...
public class FanFieldPanel extends FanAbstractFieldPanel
{
	...
	public FanFieldPanel(final String labelText, final String viewerDialogTitle, final ActionListener browseButtonActionListener,
	...
	public FanFieldPanel(final JTextField textField, final String labelText, final String viewerDialogTitle,
			final ActionListener browseButtonActionListener, final Runnable documentListener)
	{
	...
	public static FanFieldPanel withPaths(final String labelText, final String viewerDialogTitle, final ActionListener browseButtonActionListener,
			final Runnable documentListener)
	{
	...
	private static FanFieldPanel create(final String labelText, final String viewerDialogTitle, final ActionListener browseButtonActionListener,
			final Runnable documentListener)
	{
