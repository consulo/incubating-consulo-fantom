...
public class FanProjectImportStep extends ProjectImportWizardStep
{
	...
	public JComponent getComponent()
	{
		...
		final BrowseFilesListener scriptBrowseListener = new BrowseFilesListener(buildScriptPathField, FanBundle.message("build.script.path"),
				FanBundle.message("build.script.path.description"), fileChooser)
		{
			@Override
		...
		final FieldPanel scriptFieldPanel = new FieldPanel(buildScriptPathField, FanBundle.message("build.script.path"), null, scriptBrowseListener, null);
