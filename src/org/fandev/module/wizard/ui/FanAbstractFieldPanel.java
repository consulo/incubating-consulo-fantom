...
public abstract class FanAbstractFieldPanel extends JPanel
{
	...
	public FanAbstractFieldPanel(final JTextField component, final String labelText, final String viewerDialogTitle,
			final ActionListener browseButtonActionListener, final Runnable changeListener)
	{
