...
import org.fandev.impl.lang.fan.psi.api.statements.typeDefs.FanClassDefinition;
import org.fandev.impl.lang.fan.psi.api.statements.typeDefs.FanInheritanceClause;
import org.fandev.impl.lang.fan.psi.api.statements.typeDefs.FanMixinDefinition;
...
import org.fandev.impl.lang.fan.psi.stubs.elements.*;
import org.fandev.impl.lang.fan.types.FanFileElementType;
...
{
	IFileElementType FILE = new FanFileElementType(FanLanguage.INSTANCE);

	FanStubElementType<FanTypeDefinitionStub, FanClassDefinition> CLASS_DEFINITION = new FanClassDefinitionElementType();
	...
	FanStubElementType<FanTypeDefinitionStub, FanMixinDefinition> MIXIN_DEFINITION = new FanMixinDefinitionElementType();
	IElementType MIXIN_BODY = new FanElementType("MIXIN_BODY");

	FanStubElementType<FanTypeDefinitionStub, FanEnumDefinition> ENUM_DEFINITION = new FanEnumDefinitionElementType();
	IElementType ENUM_BODY = new FanElementType("ENUM_BODY");
	IElementType ENUM_VALUE = new FanElementType("ENUM_VALUE");

	FanStubElementType<FanTypeDefinitionStub, FanBuildScriptDefinition> BUILDSCRIPT_DEFINITION = new FanBuildScriptDefinitionElementType();
	...
	FanStubElementType<FanReferenceListStub, FanInheritanceClause> INHERITANCE_CLAUSE = new FanInheritanceClauseElementType();
	...
	Collection<IElementType> BLOCK_ELEMENTS = Arrays.asList(METHOD_BODY, CLOSURE_BODY, FOR_BLOCK, WHILE_BLOCK, TRY_BLOCK, CATCH_BLOCK, FINALLY_BLOCK,
			STATIC_BLOCK);
}
