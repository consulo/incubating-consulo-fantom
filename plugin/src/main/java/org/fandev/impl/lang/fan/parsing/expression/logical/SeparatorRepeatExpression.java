...
import org.fandev.impl.lang.fan.parsing.expression.ExpressionParser;
...
public abstract class SeparatorRepeatExpression implements ExpressionParser
{
	...
	protected boolean lheParser(final PsiBuilder builder, final TokenSet newStopper)
	{
		...
		{
			if(separators.contains(builder.getTokenType()) && UnaryExpression.parsePrefixExpression(builder, newStopper, this))
			{
				return true;
			}
		}
