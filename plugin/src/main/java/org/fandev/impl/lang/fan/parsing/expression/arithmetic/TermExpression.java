...
import static org.fandev.impl.lang.fan.FanElementTypes.TERM_EXPR;
import static org.fandev.impl.lang.fan.FanElementTypes.WITH_BLOCK_EXPR;
...
import org.fandev.impl.lang.fan.parsing.expression.argument.LiteralExpression;
...
import org.fandev.impl.lang.fan.parsing.statements.typeDefinitions.members.FieldDefinition;
import org.fandev.impl.lang.fan.parsing.statements.typeDefinitions.members.PropertyBlock;
...
{
	private static final TokenSet DOTS = TokenSet.create(DOT, DYN_CALL, SAFE_DOT, SAFE_DYN_CALL);
