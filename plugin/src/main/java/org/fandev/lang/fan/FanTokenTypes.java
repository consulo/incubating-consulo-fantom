...
public interface FanTokenTypes
{
	...
	TokenSet FAN_KEYWORDS = TokenSet.create(ABSTRACT_KEYWORD, AS_KEYWORD, ASSERT_KEYWORD, BREAK_KEYWORD, CASE_KEYWORD, CATCH_KEYWORD, CLASS_KEYWORD,
			CONST_KEYWORD, CONTINUE_KEYWORD, DEFAULT_KEYWORD, DO_KEYWORD, ELSE_KEYWORD, ENUM_KEYWORD, FALSE_KEYWORD, FINAL_KEYWORD, FINALLY_KEYWORD,
			FOR_KEYWORD, FOREACH_KEYWORD, IF_KEYWORD, INTERNAL_KEYWORD, IS_KEYWORD, ISNOT_KEYWORD, MIXIN_KEYWORD, NATIVE_KEYWORD, NEW_KEYWORD, NULL_KEYWORD,
			ONCE_KEYWORD, OVERRIDE_KEYWORD, PRIVATE_KEYWORD, PROTECTED_KEYWORD, PUBLIC_KEYWORD, READONLY_KEYWORD, RETURN_KEYWORD, STATIC_KEYWORD,
			SUPER_KEYWORD, SWITCH_KEYWORD, THIS_KEYWORD, THROW_KEYWORD, TRUE_KEYWORD, TRY_KEYWORD, USING_KEYWORD, VIRTUAL_KEYWORD, VOLATILE_KEYWORD,
			WHILE_KEYWORD
	...
	TokenSet CLASS_MODIFIERS = TokenSet.orSet(PROTECTION, TokenSet.create(ABSTRACT_KEYWORD, FINAL_KEYWORD, CONST_KEYWORD));

	// <mixinFlags>     :=  [<protection>] ["const"]
	TokenSet MIXIN_MODIFIERS = TokenSet.orSet(PROTECTION, TokenSet.create(CONST_KEYWORD));
	...
	TokenSet METHOD_MODIFIERS = TokenSet.orSet(PROTECTION, TokenSet.create(ABSTRACT_KEYWORD, FINAL_KEYWORD, ONCE_KEYWORD, OVERRIDE_KEYWORD,
			STATIC_KEYWORD, VIRTUAL_KEYWORD, NATIVE_KEYWORD));

	// <fieldFlags>     :=  [<protection>] ["readonly"] ["static"]
	/// Missing from Grammar ["const"] ["native"] ["volatile"] ["override"] ["virtual"] ["final"]
	TokenSet FIELD_MODIFIERS = TokenSet.orSet(PROTECTION, TokenSet.create(READONLY_KEYWORD, STATIC_KEYWORD, CONST_KEYWORD, NATIVE_KEYWORD,
			OVERRIDE_KEYWORD, VIRTUAL_KEYWORD, VOLATILE_KEYWORD, ABSTRACT_KEYWORD, FINAL_KEYWORD));

	TokenSet ALL_SLOT_MODIFIERS = TokenSet.orSet(METHOD_MODIFIERS, FIELD_MODIFIERS);

	TokenSet ALL_MODIFIERS = TokenSet.orSet(PROTECTION, TokenSet.create(ABSTRACT_KEYWORD, CONST_KEYWORD, FINAL_KEYWORD, ONCE_KEYWORD, NATIVE_KEYWORD,
			READONLY_KEYWORD, OVERRIDE_KEYWORD, STATIC_KEYWORD, VIRTUAL_KEYWORD));
	// Types
	...
	TokenSet ASSIGN_OP = TokenSet.create(EQ, MULTEQ, DIVEQ, PERCEQ, PLUSEQ, MINUSEQ, GTGTEQ, LTLTEQ, ANDEQ, XOREQ, OREQ);
	...
	TokenSet STRING_LITERALS = TokenSet.create(URI_LITERAL, STRING_LITERAL, DSL_STRING, CHAR_LITERAL);
	TokenSet NUMERIC_LITERALS = TokenSet.create(INT_LITERAL, FLOAT_LITERAL, DECIMAL_LITERAL, DURATION_LITERAL);
	TokenSet FAN_LITERALS = TokenSet.orSet(BOOL_LITERALS, STRING_LITERALS, NUMERIC_LITERALS);
}
